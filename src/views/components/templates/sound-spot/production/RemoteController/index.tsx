...
const SoundspotRemoteController = () => (
  <SectionWrap>
    <SectionTitleRow>
      <Col col>
        <SectiontTitleText>[2] Remote controller</SectiontTitleText>
      </Col>
    </SectionTitleRow>
    <Row style={{ marginBottom: rhythm(1) }}>
      <Col col>
        <SloganTitle>‘ Magnetic attachment method ’</SloganTitle>
      </Col>
    </Row>
    <Row style={{ marginBottom: rhythm(1) }}>
      <Col col={12} lg={9}>
...
export default SoundspotRemoteController;
